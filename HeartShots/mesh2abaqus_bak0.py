...
def DefineInjectionPoints(mesh):
    ...
    for face in endo_left_faces:
        ...
        if projection>-50.0 and projection<10.0:
...
def WriteAbaqusInput(mesh, mode="healthy", status="load", field_nodes=None, field_values=None, 
    ...
    if not injection and not infarct:
        ...
        file_out = open("heart_infarct_load.inp", "w")
    elif infarct and status=="displacement":
        file_out = open("heart_infarct_disp.inp", "w")
    elif injection and status=="load":
        file_out = open("heart_injecti_load.inp", "w")
    elif injection and status=="displacement":
        file_out = open("heart_injecti_disp.inp", "w")
...
infarct = True                      # True or False
injection = True                   # True or False
...
WriteAbaqusInput(mesh, mode="injection",  #"healthy", "infarct" or "injection"
                 status=status,
